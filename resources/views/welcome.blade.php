...
<html class="no-js">
    ...
    <body>
        ...
        <section id="call-to-action">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <h2 class="title wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">Donations</h1>
                                <div class="row wow fadeInDown" data-wow-delay=".4s" data-wow-duration="1000ms" style="color:#333333">
                                    <div class="col-md-4">
                            ...
                            <a href="contact.html" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".6s" data-wow-duration="500ms">More</a>
                        </div>
                    </div>
                </div>
        ...
        <section id="about">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">
        ...
        <section id="call-to-action">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <h2 class="title wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">What's new</h1>
                                <div class="row wow fadeInDown" data-wow-delay=".4s" data-wow-duration="1000ms" style="color:#333333">
                                    <div class="col-md-4">
                                        <div class="card card-margin">
                                            <div class="bg-image hover-overlay ripple" data-ripple-color="light">
                            ...
                            <a href="contact.html" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".6s" data-wow-duration="500ms">View Blog</a>
                        </div>
                    </div>
                </div>
