...
@section('content')
    <div class="container" >
        <h2 class="text-center purple-text pt-5 mb-3">Upload your video files in here</h2>
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8">
                <div class="jumbotron">
                    <form action="{{ route('uploadfilevideo') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <br>
                            ...
                            <button type="submit" name="submit" class="btn btn-secondary mt-3">Upload</button>
