...
<tbody>
    ...
    <tr>
        ...
        @if(!Auth::guest())
            ...
            <th><a href ="/edit_don/{{$item->id}}" class="btn btn-outline-warning btn-sm"> <i class="fas fa-pencil-alt"></i> </a></th>
            <th><a href = "/deletedon/{{$item->id}}" class="btn btn-outline-danger btn-sm"> <i class="fas fa-times"></i> </a> </th>
            @endif
        @endif
    @endforeach
</tbody>
