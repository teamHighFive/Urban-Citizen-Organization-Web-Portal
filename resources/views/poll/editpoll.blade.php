            ...
            <form  action="{{url('/pollupdate/'.$id)}}" method="POST"> 
              {{ csrf_field() }}
                ...
                <div class="form-group mb-4">
                  ...
                  <input type="datetime-local" class="form-control" name="end_date" class="date" placeholder="Enter End date"  value="{{ date('Y-m-d\TH:i', strtotime($questions->end_date))}}"Required>
                </div>
